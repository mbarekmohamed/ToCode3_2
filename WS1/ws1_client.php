	...
	if(isset($_POST['addbtn'])){
		...
		if(!$error){
			...
			if ($err) {
			 ...
			 try {
				/** Call insert Destination method */
...
<div class="container">
  <h2>Destinations Store SOAP Web Service</h2>
  <p>Enter <strong>id</strong> of Destination and click <strong>Fetch Destination Information</strong> button.</p>
  <br />       
  <div class='row'>
  	<form class="form-inline" method = 'post' name='form1'>
	    ...
	    <button type="submit" name='sub' class="btn btn-default">Fetch Destination Information</button>
    </form>
   </div>
   <br />
