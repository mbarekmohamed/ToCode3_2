a<?php
    ...
    $response = '';
    $result2=null;
    $wsdl = "http://localhost/tocode3_2/WS/ws1_server.php?wsdl";
			...
			if ($err) {
			 ...
			 try {
				/** Call insert Country method */
				 $response =  $client->call('insertDestination', array($destination,$country,$continent,$id));
...
<td><?php echo "<a href='http://localhost/tocode3_2/WS/ws_client.php?country=".$result->country."'>More information</a>";?></td>
